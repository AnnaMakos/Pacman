...
public class GamePlay extends JPanel implements KeyListener, ActionListener, MouseListener {
    ...
    private boolean upCan = true;
    private boolean downCan = true;
    private boolean rightCan = true;
    private boolean leftCan = true;
    private boolean goY = true;
    private boolean goX = true;
    private boolean justGoLeft = false;
    private boolean justGoRight = false;
    private boolean justGoUp = false;
    private boolean justGoDown = false;
    private boolean wantLeft = false;
    private boolean wantRight = true;
    private boolean wantUp = false;
    private boolean wantDown = false;
    private int jj;
    private int ii;
    private final float diamSize;
    private final List<Diamond> diamonds;
    private final List<Rectangle> diamondsRect;
    private int score;
    ...
    private final Ellipse2D[] ghostAction;
    ...
    protected GamePlay() {
        ...
        diamondsRect = new ArrayList<>();

        board = new Board();
        v = new Variable();
        color = new MyColor();

        diamSize = (float) board.boardSize / 4;
    ...
    protected void paintComponent(Graphics g) {
        ...
        Image pacmanDown;
        Image pacmanUp;
        ImageIcon diamondFile;
        ImageIcon heartFile;
        Image diamond;
        ImageIcon pacmanFileRight;
        ImageIcon pacmanFileLeft;
        ImageIcon pacmanFileDown;
        ImageIcon pacmanFileUp;

        super.paintComponent(g);

        String font =  "Courier New";
        Font font1 = new Font(font, Font.BOLD, 60);
        Font font2 = new Font(font, Font.BOLD, 50);
        Font font3 = new Font(font, Font.BOLD, 100);
        Font font4 = new Font(font, Font.BOLD, 180);
        ...
        if (start) {
            ...
            pacmanFileRight = new ImageIcon(Objects.requireNonNull(getClass().getClassLoader().getResource("pacman_right.png")));
            pacmanFileLeft = new ImageIcon(Objects.requireNonNull(getClass().getClassLoader().getResource("pacman_left.png")));
            pacmanFileDown = new ImageIcon(Objects.requireNonNull(getClass().getClassLoader().getResource("pacman_down.png")));
            pacmanFileUp = new ImageIcon(Objects.requireNonNull(getClass().getClassLoader().getResource("pacman_up.png")));
            ...
            // GHOSTS
            if (first[0]) {
                moveG1 = new Move(new ImageIcon(Objects.requireNonNull(getClass().getClassLoader().getResource("ghost1.png"))), 611, 481, this);
                first[0] = false;
            }
            ...
            if (!startClick[0][0]) {
                if (first[1]) {
                    moveG2 = new Move(new ImageIcon(Objects.requireNonNull(getClass().getClassLoader().getResource("ghost2.png"))), 50, 450, this);
                    first[1] = false;
                }
            ...
            if (startClick[0][2] || startClick[0][3]) {
                if (first[2]) {
                    moveG3 = new Move(new ImageIcon(Objects.requireNonNull(getClass().getClassLoader().getResource("ghost3.png"))), 550, 100, this);
                    first[2] = false;
                }
            ...
            if (startClick[0][3]) {
                if (first[3]) {
                    moveG4 = new Move(new ImageIcon(Objects.requireNonNull(getClass().getClassLoader().getResource("ghost4.png"))), 300, 300, this);
                    first[3] = false;
                }
            ...
            // DIAMENTY
            diamondFile = new ImageIcon(Objects.requireNonNull(getClass().getClassLoader().getResource("diamond.png")));
            ...
            // SERCA -ZYCIA
            heartFile = new ImageIcon(Objects.requireNonNull(getClass().getClassLoader().getResource("serce.png")));
            Image heart = heartFile.getImage();
